...
def load_config(path):
    ...
    if config["schema_version"] not in ("gzsl-paper.ara.v1","gzsl-paper.ara.v2","gzsl-paper.ara.v3","gzsl-paper.ara.v4") or config["attempt_id"] not in ("V2-TRY-092","V2-TRY-093","V2-TRY-094","V2-TRY-095","V2-TRY-096","V2-TRY-097","V2-TRY-098","V2-TRY-099","V2-TRY-100","V2-TRY-104","V2-TRY-105","V2-TRY-106","V2-TRY-107","V2-TRY-109","V2-TRY-110") or config["idea_id"] not in ("IDEA-029","IDEA-033"): raise ValueError("ARA首次TRY身份错误。")
    ...
    if config["attempt_id"] in ("V2-TRY-104","V2-TRY-105","V2-TRY-106","V2-TRY-107","V2-TRY-109","V2-TRY-110") and (config["ridge_source"]!="class_centroids" or config["sdm_enabled"] is not False or config["idea_id"]!="IDEA-033"): raise ValueError("CRA类别中心ridge配置错误。")
