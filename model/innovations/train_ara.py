...
def load_config(path):
    ...
    if config["schema_version"] not in ("gzsl-paper.ara.v1","gzsl-paper.ara.v2","gzsl-paper.ara.v3") or config["attempt_id"] not in ("V2-TRY-092","V2-TRY-093","V2-TRY-094","V2-TRY-095","V2-TRY-096","V2-TRY-097") or config["idea_id"]!="IDEA-029": raise ValueError("ARA首次TRY身份错误。")
