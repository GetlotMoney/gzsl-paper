...
def load_config(path:Path):
    ...
    expected=CONFIG_KEYS_V3 if schema=="gzsl-paper.ccgr.v3" else (CONFIG_KEYS_V2 if schema=="gzsl-paper.ccgr.v2" else CONFIG_KEYS)
    ...
    if config["schema_version"] not in ("gzsl-paper.ccgr.v1","gzsl-paper.ccgr.v2","gzsl-paper.ccgr.v3") or config["attempt_id"] not in ("V2-TRY-058","V2-TRY-059","V2-TRY-060") or config["idea_id"]!="IDEA-018": raise ValueError("CCGR首次TRY身份错误。")
