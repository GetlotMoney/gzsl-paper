...
def load_config(path:Path):
    ...
    valid_ids=("V2-TRY-058","V2-TRY-059","V2-TRY-060","V2-TRY-061","V2-TRY-062","V2-TRY-063","V2-TRY-064","V2-TRY-065","V2-TRY-066","V2-TRY-067","V2-TRY-074","V2-TRY-077","V2-TRY-078","V2-TRY-079","V2-TRY-080","V2-TRY-081","V2-TRY-082","V2-TRY-083")
    expected_idea="IDEA-026" if config.get("attempt_id")=="V2-TRY-083" else ("IDEA-025" if config.get("attempt_id") in ("V2-TRY-081","V2-TRY-082") else ("IDEA-022" if config.get("attempt_id")=="V2-TRY-074" else "IDEA-018"))
    ...
    expected_max={"V2-TRY-066":0.15,"V2-TRY-067":0.2,"V2-TRY-074":0.2,"V2-TRY-077":0.2,"V2-TRY-078":0.2,"V2-TRY-079":0.2,"V2-TRY-080":0.2,"V2-TRY-081":0.2,"V2-TRY-082":0.2,"V2-TRY-083":0.2}.get(config["attempt_id"],0.1)
    ...
    if config["attempt_id"] in ("V2-TRY-060","V2-TRY-062","V2-TRY-063","V2-TRY-064","V2-TRY-065","V2-TRY-066","V2-TRY-067","V2-TRY-074","V2-TRY-077","V2-TRY-078","V2-TRY-079","V2-TRY-080","V2-TRY-081","V2-TRY-082","V2-TRY-083") and (not config["fold_checkpoint_dir"] or int(config["batch_half"])!=32 or float(config["pseudo_unseen_weight"])!=0.25): raise ValueError("CCGR unseen风险配置错误。")
    ...
    if config["attempt_id"] in ("V2-TRY-077","V2-TRY-078","V2-TRY-079","V2-TRY-080","V2-TRY-081","V2-TRY-082","V2-TRY-083") and config["select_each_epoch"] is not True: raise ValueError("CCGR逐epoch选择配置错误。")
