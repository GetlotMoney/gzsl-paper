...
def load_config(path):
    ...
    if config["schema_version"]!="gzsl-paper.vebc.v1" or config["attempt_id"] not in ("V2-TRY-119","V2-TRY-120","V2-TRY-121","V2-TRY-125","V2-TRY-126","V2-TRY-127") or config["idea_id"]!="IDEA-037": raise ValueError("VEBC首次TRY身份错误。")
    expected_lr=0.0025 if config["attempt_id"] in ("V2-TRY-120","V2-TRY-121","V2-TRY-125","V2-TRY-126","V2-TRY-127") else 0.01
    expected_gamma=0.3 if config["attempt_id"] in ("V2-TRY-121","V2-TRY-125","V2-TRY-126","V2-TRY-127") else 0.25
