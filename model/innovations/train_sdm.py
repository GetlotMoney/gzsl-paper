...
def load_config(path:Path):
    ...
    if config["schema_version"] not in ("gzsl-paper.sdm.v1","gzsl-paper.sdm-low-rank.v1","gzsl-paper.sdm-low-rank.v2") or config["attempt_id"] not in ("V2-TRY-086","V2-TRY-087","V2-TRY-088") or config["idea_id"]!="IDEA-028": raise ValueError("SDM首次TRY身份错误。")
