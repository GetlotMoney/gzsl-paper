...
def load_config(path):
    ...
    if c["schema_version"]!="gzsl-paper.ncra.v1" or c["experiment_id"]!="V2-INNOVATION-011" or c["idea_id"]!="IDEA-045": raise ValueError("NCRA身份错误。")
    ...
    if c["optimizer"]!="Adam" or float(c["learning_rate"])!=0.01 or float(c["weight_decay"])!=0.0 or float(c["max_beta"])!=5.0: raise ValueError("NCRA优化参数错误。")
