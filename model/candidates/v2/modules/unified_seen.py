...
from model.frameworks.v4.ccgr import tangent_direction_basis
from model.frameworks.v4.tg import VariableClassTGVPR
from model.frameworks.v4.tst import tangent_transport
...
class UnifiedSeenPrototypeModel(nn.Module):
    ...
    def prototype_stages_from_tg(
        ...
        *,
        ...
        if detach_tg_inputs:
            tg_prototypes = tg_prototypes.detach()
            value_prototypes = value_prototypes.detach()
            role_prototypes = role_prototypes.detach()
