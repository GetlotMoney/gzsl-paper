...
from model.innovations.train_cara import load_config
...
def test_cara_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_102_cara_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-102" and config["max_beta_residual"]==4.0; source=(ROOT/"model/innovations/train_cara.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
