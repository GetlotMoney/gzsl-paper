...
import torch
from model.innovations.hgcs import HierarchicalGroupCommonSuppression,spherical_name_groups
from model.innovations.train_hgcs import load_config
...
def test_hgcs_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_146_hgcs_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-146" and config["group_count"]==20; source=(ROOT/"model/innovations/train_hgcs.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
