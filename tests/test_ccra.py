...
from model.candidates.v2.trainers.train_ccra import load_config
...
def test_ccra_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_108_ccra_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-108" and config["attribute_rank"]==16; source=(ROOT/"model/candidates/v2/trainers/train_ccra.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
