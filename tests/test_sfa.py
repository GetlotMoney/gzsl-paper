...
from model.innovations.train_sfa import load_config
...
def test_sfa_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_103_sfa_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-103" and config["factor_rank"]==64; source=(ROOT/"model/innovations/train_sfa.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
