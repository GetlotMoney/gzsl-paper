...
from model.candidates.v2.trainers.train_adma import load_config
...
def test_adma_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_136_adma_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-136" and config["max_log_weight"]==0.1; source=(ROOT/"model/candidates/v2/trainers/train_adma.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
