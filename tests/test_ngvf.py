...
from model.innovations.train_ngvf import load_config
...
def test_ngvf_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_137_ngvf_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-137" and config["reverse_ridge"]==0.01; source=(ROOT/"model/innovations/train_ngvf.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
