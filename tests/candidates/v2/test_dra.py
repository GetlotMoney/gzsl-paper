...
from model.candidates.v2.trainers.train_dra import load_config
...
def test_dra_config_and_boundary():
    config,_=load_config(ROOT/"config/tries/v2_try_101_dra_seed17.yaml"); assert config["attempt_id"]=="V2-TRY-101" and config["ridge"]==0.01; source=(ROOT/"model/candidates/v2/trainers/train_dra.py").read_text(encoding="utf-8"); assert 'unseen_images_used_for_gradient":False' in source
