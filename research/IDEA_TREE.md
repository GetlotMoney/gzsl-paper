...
| `learning_generalization` | 训练目标与选择规则如何迁移到未见类别 | [`IDEA-212 / One-Text Seen-Only CE`](ideas/IDEA-212_one_text_seen_only_ce.md)：机制支持，CUB H=79.945797但低formal V7 0.564635，当前条件drop；[`IDEA-214 / Text Relation Visual Operator`](ideas/IDEA-214_text_relation_visual_operator.md)：删除逐图Reader的共享文本到视觉算子失败，CUB H=79.437516低formal V7 1.072915，drop |
