...
| `class_competition` | 细粒度候选和seen/unseen联合竞争如何避免错误修正 | [`IDEA-201 / C-PCLR`](ideas/IDEA-201_compiled_pclr.md)，Gate A通过但fixed-200 Gate B低于正式V5和同预算online-V5，`rejected/below_parent` |
