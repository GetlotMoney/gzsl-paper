...
|---|---|---|
| `expert_attribute_candidate_verification` | 三态属性证据怎样同时保留unknown并服务类别判别 | [`IDEA-227 / HAEL`](ideas/IDEA-227_hael.md)：class CE把CBA提到26%，但unknown recall塌至1%、patch仅+0.23pp |
