...
| `learning_generalization` | 训练目标与选择规则如何迁移到未见类别 | [`IDEA-212 / One-Text Seen-Only CE`](ideas/IDEA-212_one_text_seen_only_ce.md)：机制支持，CUB H=79.945797但低formal V7 0.564635，当前条件drop；[`IDEA-215 / De-Parent S/V/I Mask Diagnostic`](ideas/IDEA-215_de_parent_svi_mask_diagnostic.md)：冻结TG+GTD、head改Mean8 base，判定“TG+GTD遮蔽V/I”vs“CLS路径到顶”（诊断） |
