...
|---|---|---|
| `expert_attribute_candidate_verification` | 人类属性能否形成support/refute/unknown局部证据而非普通属性残差 | [`IDEA-226 / AELI`](ideas/IDEA-226_aeli.md)：三态F1与LLR方向成立，patch-only弱于global且绝对分类未校准，进入联合global+patch补救 |
