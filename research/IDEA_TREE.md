...
| `learning_generalization` | 训练目标与选择规则如何迁移到未见类别 | [`IDEA-212 / One-Text Seen-Only CE`](ideas/IDEA-212_one_text_seen_only_ce.md)：机制支持，CUB H=79.945797但低formal V7 0.564635，当前条件drop；[`IDEA-213 / Class-Held-Out V/I Training`](ideas/IDEA-213_class_held_out_vi_training.md)：一阶class-held-out outer CE，CUB H=80.138486相对TUNE013 +0.192688，仍低formal V7 0.371946，仅作训练机制候选 |
