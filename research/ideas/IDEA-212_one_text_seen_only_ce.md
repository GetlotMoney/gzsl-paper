...
retrained_ablation_evidence: V7-ABLATION-002（code commit ed2655e）四组从头重训消融：S-off +0.502084 H（H=79.443713），V-off +0.256176 H（H=79.689621），I-off +0.246076 H（H=79.699721），V+I-off +0.246076 H（H=79.699721，与I-off逐值相同）。S仍有稳定小正贡献；旧全局V/I联合贡献不足1H且I信息量接近0，判定旧V/I收掉，不作为核心创新。
