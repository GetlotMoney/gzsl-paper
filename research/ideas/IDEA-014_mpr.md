...
角色偏置学到local为正、unique/overall为负，但U/S/H/ZS全部下降，`Delta H=-0.268817`。三角色raw原型不能提供可靠独立分类证据，继续稀疏路由会重复ICGR/ACGR路径，因此IDEA-014提前止损并标记`rejected`。
