...
minimal_viability: exact Stage1/Stage2 counts and SHAs; nonzero gradients in all enabled S/V/I paths; both trigger/abstain and keep/swap; at least two occupied actions without one action exceeding a preregistered collapse bound; zero raw crop/eval-all25 physical access; nonconstant I scores.
