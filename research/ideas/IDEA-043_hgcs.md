...
pseudo-unseen episode把beta更强地推向正值`7.05–9.53`，official H持续降到约`80.02%`，最终仍选回epoch 0。seen CE与episode训练都反对负公共模式抑制，IDEA-043标记`rejected`，不再补救。
