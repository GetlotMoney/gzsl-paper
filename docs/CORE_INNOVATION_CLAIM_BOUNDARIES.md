...
| 核心创新 | 可以主张 | 禁止主张 | 最近先例 |
|---|---|---|---|
| TG-VPR | 在GPT视觉描述基础上，固定划分local/unique/overall角色组，使用共享Value重参数化、等权组融合和topology约束构造GZSL原型 | 首次使用GPT描述、首次结构化/对比式LLM描述、首次多描述CLIP、首次用细粒度图像适配描述 | PAPER-001、PAPER-004、PAPER-009、PAPER-010 |
